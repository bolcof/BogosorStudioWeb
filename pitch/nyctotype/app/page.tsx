...
const chapters: Chapter[] = [
  ...
  { id: 'devices', title: 'ゲーミングデバイス制作企業との協業', label: 'DEVICE PARTNERS', source: '2611:208', className: 'with-heading-inset', body: <div className="device-layout"><div><Text id="2611:216"/><div className="text-block partner-details"><h3>機材提供の実績</h3><p>台北ゲームショウ2026では、EPOMAKER様・LINSOUL様より展示用キーボード・オーディオ機器の提供を受けました。</p></div><Note>今後のコラボ製品や大会協賛についても、ご相談させていただければと思います。</Note></div><Slot name="keyboard"/></div> },
